...
export default function Daily() {
  return (
    <section className="relative flex flex-col-reverse md:flex-row min-h-screen">
      ...
      >
        ...
        <ul className="text-lg md:text-xl text-[#10482B] max-w-[600px] leading-relaxed mt-6 space-y-4">
